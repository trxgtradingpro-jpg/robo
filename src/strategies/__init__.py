...
from .ganhador_80 import STRATEGY as GANHADOR_80_STRATEGY
from .trx_htsl import STRATEGY as TRX_HTSL_STRATEGY
from .trx_melhor_20_02 import STRATEGY as TRX_MELHOR_20_02_STRATEGY
...
STRATEGIES: dict[str, StrategySpec] = {
    ...
    GANHADOR_80_STRATEGY.name: GANHADOR_80_STRATEGY,
    TRX_HTSL_STRATEGY.name: TRX_HTSL_STRATEGY,
    TRX_MELHOR_20_02_STRATEGY.name: TRX_MELHOR_20_02_STRATEGY,
}
